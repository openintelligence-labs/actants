...
from agentic_kit.a2a.executor import build_executor
...
def build_app(
    ...
    *,
    ...
    try:
        ...
        raise ImportError(
            "A2A support requires `pip install agentic-kit[a2a]`. Install Starlette too."
        ) from exc

    card = build_agent_card(
        name=name or "agentic-kit-agent",
        description=description or "An agent built with agentic-kit",
        version=version,
        url=base_url,
        tools=agent.tools,
    )
