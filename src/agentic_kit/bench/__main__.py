"""``python -m agentic_kit.bench`` entrypoint.
...
from agentic_kit.bench.runner import COMPETITORS, format_table, run_all


def main() -> None:
    parser = argparse.ArgumentParser(prog="python -m agentic_kit.bench")
