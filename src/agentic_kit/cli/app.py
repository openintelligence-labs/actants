...
try:
    ...
    raise ImportError(
        "agentic_kit.cli requires the 'cli' extra: pip install 'agentic-kit[cli]'"
    ) from exc

from agentic_kit.observability.logging import setup_logging
...
def make_app(name: str, *, help: str | None = None) -> click.Group:  # noqa: A002 — matches Click idiom
    """Create a Click group with sensible defaults for an agentic-kit-based app.
