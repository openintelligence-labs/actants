...
from agentic_kit.tracing.otel import llm_span
...
class LLMSettings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="AGENTIC_KIT_", extra="ignore")
    ...
    async def complete(
        ...
        *,
        ...
        if semantic_cache is not None and use_cache and not tools:
            ...
            from agentic_kit.cache.memory import make_key
